  ...
  <body>
                ...
                <div class="card-body pd-0 table-responsive">
                  <table id="example1" class="table table-borderless mg-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="td-its align-middle border-bottom"><?php echo $r->nama_instansi ?></td>
                        <td class="td-its align-middle border-bottom"><a href="#" class="btn btn-white btn-icon btn-delete" role="button" data-toggle="modal" data-target="#hapusvaksinator" data-animation="effect-scale" data-id="<?php echo $r->id_vaksinator ?>"><i data-feather="trash" class="wd-10"></i></a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
    ...
    <div class="modal fade effect-scale" id="tambahvaksinator" tabindex="-1" role="dialog" aria-labelledby="modalmyfile" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form method="post" action="<?php echo base_url();?>admin/vaksinator/add/">
        ...
        <div class="modal-content tx-14 bg-white">
          ...
          <div class="modal-footer bd-t-0">
            <form>
              ...
              <a href="<?php echo base_url();?>admin/vaksinator/delete/" id="link-delete" class="btn btn-its tx-montserrat tx-semibold mg-l-5">Hapus</a>
            </form>
          </div>
        </div>
      </div>
    ...
    <script type="text/javascript">
      $(".btn-delete").click(function(){
        var id=$(this).data("id");
        $("#link-delete").attr("href","<?php echo base_url();?>admin/vaksinator/delete?id="+id);
        console.log(id);
      });
    </script>
