...
<html lang="en">
  ...
  <body>
    <aside class="aside aside-fixed">
                ...
                <a href="<?php echo base_url();?>beranda" class="tx-montserrat tx-semibold tx-18 aside-logo">myITS Vaksin</a>
    ...
    <div class="content ht-100v pd-0" style="position: relative">
          ...
          <div>
              <a href="<?php echo base_url();?>beranda" class="tx-montserrat tx-semibold tx-18 d-lg-none">myITS Vaksin</a>
          </div>
          <nav class="nav r-25 pos-fixed z-index-10">
              <div class="dropdown dropdown-profile allow-focus">
                ...
                <div class="dropdown-menu dropdown-menu-right allow-focus">
                  ...
                  <!-- a href="<?php echo base_url();?>dashboard/login-mhs.html" class="dropdown-item ht-30"><i data-feather="log-out"></i>Keluar</a !-->
                </div>
              </div>
          </nav>
      </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content bg-white">
            <div class="modal-body">
              ...
              <p class="tx-color-02">Hak akses Anda saat ini: <b>Pegawai </b>.</p>
              <select class="form-control" id="menu">
                <option selected="selected">Select One</option>
                <option value="<?php echo base_url();?>beranda">Pegawai</option>
                <option value="<?php echo base_url();?>beranda_admin">Admin</option>
              </select>
